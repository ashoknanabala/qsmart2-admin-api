...
public class DepartmentNewUpDto {

    @ApiModelProperty(required = true, notes = "Department id should't be empty", example = "1")
    @NotNull(message = "{dept.dto.dptid.notnull}")
    ...
    @NotNull(message = "{dept.dto.floorid.notnull}")
...
//    @NotNull(message = "{dept.dto.pharma_Type.notnull}")
    ...
    public String toString() {
        return "DepartmentNewUpDto{" + "deptId=" + deptId + ", orgId=" + orgId + ", deptName=" + deptName + ", floorId=" + floorId + ", deptArbName=" + deptArbName + ", dept_Multiple_Token=" + dept_Multiple_Token + ", deptType=" + deptType + ", pharmaLocation=" + pharmaLocation + ", pharmaIndex=" + pharmaIndex + ", pharmaType=" + pharmaType + ", print_waiting_token=" + print_waiting_token + '}';
    }
