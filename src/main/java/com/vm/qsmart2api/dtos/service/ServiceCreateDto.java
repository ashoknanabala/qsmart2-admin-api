...
public class ServiceCreateDto {
    ...
    @ApiModelProperty(required = false, notes = "endTime should't be empty", example = "5")
...
//    }
    ...
    public String toString() {
        return "ServiceCreateDto{" + "deptId=" + deptId + ", floorId=" + floorId + ", orgId=" + orgId + ", serviceEngName=" + serviceEngName + ", servicePrefix=" + servicePrefix + ", startToken=" + startToken + ", endToken=" + endToken + ", serviceArName=" + serviceArName + ", npEarlyCheckin=" + npEarlyCheckin + ", npLateCheckin=" + npLateCheckin + ", patientEarlyCheckin=" + patientEarlyCheckin + ", patientLateCheckin=" + patientLateCheckin + ", serviceColor=" + serviceColor + ", serviceType=" + serviceType + '}';
    }
